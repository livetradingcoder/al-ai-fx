...
/////////////////////////////////////////////////////////////////////////
// USER INPUTS
input EnumRiskMode RiskMode = FIXED_LOT;  // Risk Mode
input double LotSize = 0.1;              // Lot size
input double Compound = 1.0;               // Compound (%)
/////////////////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////////////////
// FIXED SETTINGS - Hidden from user interface
// Basic Settings
int MagicNumber = 20250526;              // Magic Number Base
string comm = "GG - GoldBot";            // Trade Comment base - MUST NOT contain "_" (breaks own-order recognition)

// Trade Restrictions
string IgnoreDates = "";                 // Custom holiday dates

// Time Settings
int TimeStart = 1;                       // Range 1 Start Hour
int TimeStartMinute = 0;                 // Range 1 Start Minute
int TimeStop = 5;                        // Range 1 Stop Hour
int TimeStopMinute = 0;                  // Range 1 Stop Minute
int TimeStart2 = 2;                      // Range 2 Start Hour
int TimeStartMinute2 = 35;               // Range 2 Start Minute
int TimeStop2 = 11;                      // Range 2 Stop Hour
int TimeStopMinute2 = 5;                 // Range 2 Stop Minute

// Range 1 Settings
double StopLossFB1 = 21.0;               // Stop Loss First Buy (Range 1)
double TakeProfitFB1 = 3.7;              // Take Profit First Buy (Range 1)
double Buffer1 = 0.16;                   // Buffer (Range 1)
double StopLossFS1 = 11.2;               // Stop Loss First Sell (Range 1)
double TakeProfitFS1 = 1.5;              // Take Profit First Sell (Range 1)
double Multiplier1 = 5.0;                // Multiplier (Range 1)
double TakeProfitST1 = 2.0;              // Take Profit Second Trade (Range 1)

// Range 2 Settings
double StopLossFB2 = 11.8;               // Stop Loss First Buy (Range 2)
double TakeProfitFB2 = 2.1;              // Take Profit First Buy (Range 2)
double Buffer2 = 0.16;                   // Buffer (Range 2)
double StopLossFS2 = 12.0;               // Stop Loss First Sell (Range 2)
double TakeProfitFS2 = 1.8;              // Take Profit First Sell (Range 2)
double Multiplier2 = 3.0;                // Multiplier (Range 2)
double TakeProfitST2 = 4.5;              // Take Profit Second Trade (Range 2)

// Hybrid Settings
double MinDistanceMultiplier = 1.5;      // Min Distance Multiplier
/////////////////////////////////////////////////////////////////////////
