    ...
    <main className="main-content" style={{ maxWidth: "1000px", margin: "0 auto", padding: "6rem 2rem" }}>
      ...
      <div className="checkout-grid">
        <div className="glass-panel">
          <h2 style={{ fontSize: "1.5rem", marginBottom: "2rem" }}>{t("accPaymentDetails")}</h2>
          {isSuccess ? (
            <div style={{ textAlign: "center", padding: "2rem 0" }}>
              ...
              <h2 style={{ fontSize: "2rem", marginBottom: "1rem" }}>{t("accountActivated")}</h2>
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <label style={{ fontSize: "0.9rem", color: "var(--text-secondary)" }}>{t("emailAddress")}</label>
                <input
                  type="email"
              ...
              <div style={{ padding: "1rem", borderRadius: "var(--radius-sm)", border: "1px dashed var(--border-color)", background: "var(--bg-secondary)", textAlign: "center" }}>
              ...
              >
                ...
                >
                  {isFreeTrial ? t("startFreeTrial") : isSubmitting ? t("redirecting") : t("proceedToPaygate")}
                </button>
              </div>
            </form>
          )}
