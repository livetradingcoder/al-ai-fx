...
- [x] 03-03-encrypted-source-storage-PLAN.md — AES-256-GCM `source-encryption.ts` + versioned Blob `uploadEncryptedSource` (`sources/<slug>/v<N>.mq5.enc`) + provision `SOURCE_ENCRYPTION_KEY` + upload real GoldBot v1 from VM [Wave 2, parallel with 03-02] ✅ 2026-07-05
